...
namespace GameDev.Services
{
    public class SQLDataStore : IDataStore
    {
        ...
        {
            // Mock data for Items
            App.Database.InsertAsync(new Item("Noisy Cricket", "Small, portable gun which make huge boom!!!", null, AttributeEnum.Attack, ItemLocationEnum.OffHand, 10, 10));
            App.Database.InsertAsync(new Item("De-Atomizer", "Heavy machinery which can reduce opponents to atoms.", null, AttributeEnum.Attack, ItemLocationEnum.PrimaryHand, 10, 10));
            App.Database.InsertAsync(new Item("Anti-Gravity Shoes", "Defy gravity and take your fight in air", null, AttributeEnum.Defense, ItemLocationEnum.Feet, 10, 10));
